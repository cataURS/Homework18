...
public class SeleniumWrappers {
	...
	/**
	 * Custom sendKeys method/ Wraps selenium default SendKeys and enhace it with
	 * clear() method before sending the text.
	 * 
	...
	public void dragAndDrop(By locator, int x, int y) {
		...
		// action.clickAndHold(element).moveByOffset(300,
